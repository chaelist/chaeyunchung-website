...
const books = [
  ...
  {
    title: "그림자 마법사들 III:",
    subtitle: "영혼과 그림자의 전투",
    description:
      "섀드의 힘을 되찾고 다시 움직이기 시작한 악당과, 새롭게 발현한 힘을 무기로 그를 추격하는 주인공. 세계의 운명을 건 거대한 대결의 이야기.",
    synopsis:
      "두 번째 그림자를 얻어 섀드의 힘을 되찾은 제론. 다이앤 미첼이 이끄는 마르세유의 비밀 조직과 제론 일당은 각각 섀드 세계를 집어삼킬 거대한 음모의 완성을 향해 달려가고, 리안은 자신이 발현한 새로운 힘의 정체를 찾아 시카고에서 콜롱주 라 루즈로, 다시 이스탄불로 향한다. 마침내 리안이 간직한 힘의 비밀이 밝혀지고, 악마의 그림자 조각 ‘샤티아텐’을 손에 넣은 제론은 또다시 대대적인 그림자 갈취를 일으킨다. 제론을 바짝 추격하며 그를 막아서려는 리안. 제론이 섀드 세계를 완전히 무너뜨릴 마지막 마법을 준비하는 남태평양의 한 섬에서, 세계의 운명을 건 최후의 전투가 펼쳐진다.",
    backdrop: "/Shads3-background.png",
    alt: "그림자 마법사들 3권 표지",
    href: "https://product.kyobobook.co.kr/detail/S000220930693"
  }
];
